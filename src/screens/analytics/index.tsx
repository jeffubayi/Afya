      ...
      <div>
        ...
        <Grid container spacing={1}>
          ...
          <Grid container xs={8} spacing={3}>
            ...
            <Grid item xs={4}>
              <Card title="Footfall" amount={4.8} caption="patients" />
            </Grid>
            <Grid item xs={4}>
              <Card title="Patient Satisfaction" amount={13} caption="NPS" />
            </Grid>
            <Grid item xs={4}>
              <Card title="Revenue" amount={4.2} caption="kenyan shillings" />
            </Grid>
            <Grid item xs={12}>
              <StaffList />
            </Grid>
